...
#ifndef BAUD_RATE
#if F_CPU >= 8000000UL
#define BAUD_RATE   115200UL // Highest rate Avrdude win32 will support
#elif F_CPU >= 1000000UL
#define BAUD_RATE   9600UL   // 19200 also supported, but with significant error
#elif F_CPU >= 128000UL
#define BAUD_RATE   4800UL   // Good for 128kHz internal RC
#else
#define BAUD_RATE 1200UL     // Good even at 32768Hz
#endif
#endif
